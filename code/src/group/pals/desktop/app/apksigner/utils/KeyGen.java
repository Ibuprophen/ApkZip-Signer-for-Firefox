...
public class KeyGen {
     ...
     *             if any occurred.
     */
    public static void genKey(File jdkPath, File target, char[] storepass,
            String alias, char[] keypass, int aliasYears, String coName,
            String ouName, String oName, String city, String state,
        ...
        ProcessBuilder pb = new ProcessBuilder(new String[] { keytool,
                "-genkey", "-keyalg", "RSA", "-alias", alias, "-keypass",
                new String(keypass), "-validity", Integer.toString(aliasYears),
